...
def run():
    ...
    path_aligned_masks = f'{workdir}/*/mask_aligned2/piecewise'
    path_kpts = f'{workdir}/*/keypoints'
    # path_output = "Z:/Public/Jonas/011_STB_leaf_tracking/output/ts4"
    path_output = "/home/anjonas/public/Public/Jonas/011_STB_leaf_tracking/output/ts4"
